...
const messages = [
  'Received: "Buy the Snitch jacket for under ₹3000..."',
  "Checking Merchant Firewall → snitch2-black-tee allowed",
  "Budget check complete: ₹2999 is within auto-approve limit",
  "Injecting intent into Cryptographic Signer (1.2s)",
  "Server-to-Server connection established with Merchant",
  "Merchant signed payload: ₹2999 / x-rzp-39f82a...",
  "Triggering Razorpay Headless Checkout",
  "Payment successful. Webhook captured.",
  "Workflow complete. Item purchased autonomously in 342ms.",
  "Idle. Listening for next buyer intent...",
]
...
export function EnterpriseAIPipeline() {
  ...
  return (
    <div className="bg-[#090909] border border-white/[0.08] rounded-[14px] overflow-hidden font-sans w-full max-w-[620px] mx-auto shadow-2xl">
      {/* Header */}
      ...
      <div className="border-t border-white/[0.06] px-[18px] py-[10px] flex gap-[22px] items-center">
        <div>
          <div className="text-[9px] text-white/20 tracking-[0.09em] mb-[3px]">TRANSACTIONS</div>
          <motion.div
            key={workflows}
            initial={{ scale: 1.05 }}
            animate={{ scale: 1 }}
        ...
        <div>
          <div className="text-[9px] text-white/20 tracking-[0.09em] mb-[3px]">VOLUME</div>
          <div className="text-[16px] text-white/[0.72] font-mono">₹2.4M</div>
        </div>
        <div>
        ...
        <div className="ml-auto text-right">
          ...
          <div className="text-[10px] text-[#0052FF]/55 font-mono">Razorpay · Node.js</div>
        </div>
      </div>
    </div>
  )
